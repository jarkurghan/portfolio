if (lang === "uz") {
    ...
    document.querySelector("#about>.info").textContent =
        "Dasturlashga kirib kelishim universitet davrida bo'lgan. Dasturlash sohasiga yaqin bo'lgan axborot xavfsizligi yo'nalishi C++, Python va Web dasturlash bo'yicha boshlang'ich bilimlarimni olishimga sabab bo'lgan. Professional tajribam esa 2021-yil 4-kurslik davrimda boshlangan";
    document.querySelector("#experience>.title").textContent = "Tajriba";
    document.querySelector('a[href*="transoxania.uz"] .experience-profession').textContent = "Full-Stack dasturchi";
    ...
    document.querySelector('a[href*="digitalgov.uz"] .experience-description-info').textContent =
        "DigitalGov Innovation HUB MChJda mentor. Maktab o'qituvchilariga C++ tilida dasturlash asoslaridan dars berganman. Lekin ustozlik davrim uzoq davom etmadi, chunki darslik ikki oyga mo‘ljallangan edi";
    ...
    document.querySelector('a[href*="virtual-lugat.uz"] .project-description-info').textContent =
    ...
    document.querySelector('a[href*="transoxania.travel"] .project-description-info').textContent =
    ...
    document.querySelector(".projects-description-warning-info").textContent =
    ...
    document.querySelector("#about>.info").textContent =
        "Я начал заниматься программированием, когда учился в университете. Фокус на информационной безопасности, близкий к области программирования, привел к моим первоначальным знаниям C++, Python и веб-программирования. Мой профессиональный опыт начался на 4-м курсе 2021 года";
    ...
    document.querySelector('a[href*="digitalgov.uz"] .experience-description-info').textContent =
        "Mentor в DigitalGov Innovation HUB ООО. Я преподавал основы программирования на C++ школьным учителям. Мой период наставничества длился недолго, так как учебник был рассчитан на два месяца";
    ...
    document.querySelector("#about>.info").textContent =
        "I started programming when I was studying at the university. An information security focus close to the field of programming led to my initial knowledge of C++, Python and Web programming. My professional experience started during my 4th year of 2021";
    ...
    document.querySelector('a[href*="digitalgov.uz"] .experience-description-info').textContent =
        "Mentor at DigitalGov Innovation HUB LLC. I taught the basics of C++ programming to school teachers. My mentoring period did not last long because the textbook was designed for two months";
    ...
    document.querySelector(".projects-description-warning-info").textContent =
        "You can contact me to access some of the programs above. I can't write down passwords for privacy";
    document.querySelector(".translate-text").textContent = "translate";
}
