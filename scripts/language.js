if (lang === "uz") {
    ...
    document.querySelector('.projects-description-warning-info').textContent = "Вы можете связаться со мной, чтобы получить доступ к некоторым из вышеперечисленных программ. Я не могу записывать пароли для конфиденциальности";
    ...
    document.querySelector('.projects-description-warning-info').textContent = "You can contact me to access some of the programs above. I can't write down passwords for privacy";
